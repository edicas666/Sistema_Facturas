...
<body>
    <form class="form-horizontal" action="crear_usuarios.php" method="post" id="form">
      ...
      <div class="form-group">
        ...
        <div class="col-sm-10">
          <input id="idCuenta" type="text" name="nombre" value="" placeholder="ejemplo: 10000-11301"
      ...
      <div class="form-group">
        ...
        <div class="col-sm-10">
          <input type="text" name="apaterno" value="" placeholder="ejemplo: Sueldos base" class="form-control" onkeypress="LetrasEspacios()" maxlength="40">
        </div>
      </div>
      <div class="form-group">
        <label for="amaterno" class="col-sm-2">* Capitulo:</label>
        <div class="col-sm-10">
          <input type="text" name="amaterno" value="" placeholder="ejemplo: 1000" class="form-control" onkeypress="validarNumeros()" maxlength="6">
        </div>
      </div>
      <div class="form-group">
